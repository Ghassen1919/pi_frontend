...
@Component({
  selector: 'app-financialnews1',
  templateUrl: './financialnews1.component.html',
  styleUrls: ['./financialnews1.component.css']
})
export class Financialnews1Component implements OnInit, AfterViewInit {
  tableData: any;
  tableData1: any;
  private tradingViewWidget: any;
  private defaultSymbol = "BTCUSD"; // Set a default symbol

  constructor(private claimService: ClaimService) { }

  ngOnInit(): void {
    this.claimService.getTableData2().subscribe(data => {
      this.tableData = data;
      
    });
    this.claimService.getTableData8().subscribe(data => {
